...
- `public/index/` contains documents, task frames, hybrid index, aliases, ontology, and manifest.
...
- Official and public sources rank before lower-authority resources when both match the task.
...
- Every ranked item should have a concise score reason.
...
- Hybrid retrieval and utility ranking;
