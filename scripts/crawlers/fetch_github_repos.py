...
from config.indexer_config import GITHUB_SOURCE_CONFIG_PATH, clean_env_value
...
GITHUB_TOKEN = clean_env_value("NJUPT_SEARCH_GITHUB_TOKEN") or clean_env_value("GITHUB_TOKEN")
